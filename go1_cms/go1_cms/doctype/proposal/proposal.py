...
def generate_pdf(page, name):
	...
	page_template += "h3 {font-size: 12px;}h2 {font-size: 14px;}.page{padding: 60px 20px !important;}.page{font-family: Poppins, 'Source Sans Pro' !important;}p{font-size:16px;}"
	page_template += '.logo {height: 1.5rem;width: auto;margin-right: 1rem;}.logotype {display: flex;align-items: center;font-weight: 700;}'
