...
frappe.ui.form.on("Proposal", {
  refresh: function (frm) {
    if (frm.doc.document) {
      ...
      frappe.call({
        method:
          "go1_cms.go1_cms.doctype.proposal.proposal.get_side_menu_fields",
        args: {
    ...
    if (!frm.__islocal && frm.doc.published == 1) {
      ...
      frm.add_custom_button(__("Preview"), function () {
        window.open(window.location.origin + "/" + frm.doc.route, "_blank");
      });
      // by gopi on 20/10/22
      frm.add_custom_button(__("Send Document"), function () {
        if (frm.doc.preview_pdf_url && frm.doc.quotation) {
          ...
          frappe.call({
            method:
              "go1_cms.go1_cms.doctype.proposal.proposal.get_attachement_email_id",
            args: {
            ...
            callback: function (r) {
              var msg =
                "Dear {{customer}}<br><br>Please find our attached proposal.<br><br>This proposal is valid until: {{valid_till}}<br>";
              msg +=
                'You can view the proposal on the following link: <a href="{{route}}" target="_blank">{{name}}</a><br><br>Please ';
              msg +=
                "don't hesitate to comment online if you have any questions.<br><br>We look forward to your communication.<br><br>Kind Regards,<br>{{company}}<br>";
              frappe.call({
                ...
                callback: function (data) {
                  if (data.message) {
                    msg = frappe.render_template(msg, {
                      customer: data.message.party_name,
                      valid_till: data.message.valid_till,
              ...
              if (!r.email) {
                frappe.show_alert(
                  "There is no email id found , Please select or type <b>To</b> email from the dialog",
                  5
                );
              }
              // console.log(msg);
      ...
      frm.add_custom_button(__("Preview PDF"), function () {
        window.open(
          window.location.origin +
            "/api/method/go1_cms.go1_cms.doctype.proposal.proposal.generate_pdf?page=" +
            frm.doc.name +
            "&&name=" +
            frm.doc.quotation,
          "_blank" // <- This is what makes it open in a new window.
    ...
    if (!frm.doc.__islocal && frm.doc.is_converted_to_template == 0) {
      frm.add_custom_button(__("Save As Template"), function () {
        ...
        title_dialog.set_primary_action(__("Save As Template"), function () {
          ...
          frappe.call({
            method:
              "go1_cms.go1_cms.doctype.proposal.proposal.save_as_template",
            args: {
  ...
  edit_styles_sections: function (frm, name, parentfield) {
    ...
    frappe.call({
      method:
        "go1_cms.go1_cms.doctype.proposal.proposal.get_section_properties",
      ...
      callback: function (r) {
        if (r.message.styles) {
          ...
          styledialog.set_primary_action(__("Save"), function () {
            ...
            frappe.call({
              method:
                "go1_cms.go1_cms.doctype.proposal.proposal.update_section_properties",
              args: {
  ...
  section_html: function () {
    ...
    if (me.groups.length > 0) {
      ...
      wrapper
        .find("#SectionList")
        .append(
          "<div class='col-md-3' id='sec-left-content' style='display:none;background-color: #fff;    height: 478px;margin-left: -20px;position: absolute;left: 0;border-right: 1px solid #ddd;overflow-y: auto;overflow-x: hidden;margin-top: -15px;width: 25%;'></div>"
        );
      wrapper
        .find("#SectionList")
        .append(
    ...
    data.map((f) => {
      ...
      let item =
        $(`<div class="col-md-3 col-sm-6 col-xs-6" style="float:left" data-group='${f.section_group}'>
        ...
        if (me.section_type == "existing") {
          ...
          title_dialog.set_primary_action(__("Add Section"), function () {
            ...
            if (me.selected_section.length > 0) {
              ...
              frappe.call({
                method:
                  "go1_cms.go1_cms.doctype.proposal.proposal.convert_template_to_section",
                args: {
                  template: me.selected_section[0].template,
                  business: cur_frm.doc.business,
                  section_name: custom_title,
...
var modify_section_data = Class.extend({
  ...
  get_blog_category: function (type) {
    ...
    if (type == "shuffle") {
      if (is_dynamic_data_val == 0 && reference_name_val != "") {
        frappe.call({
          method:
            "go1_cms.go1_cms.doctype.proposal.proposal.get_shuffled_blog_category",
          args: {
  ...
  get_category_products: function (type) {
    ...
    if (type == "shuffle") {
      if (is_dynamic_data_val == 0 && reference_name_val != "") {
        frappe.call({
          method:
            "go1_cms.go1_cms.doctype.proposal.proposal.get_shuffled_category_products",
          args: {
            category: reference_name_val,
            no_of_records: no_of_records_val,
          },
  ...
  save_data: function () {
    ...
    if (results.length > 0 || me.list_section_data.length > 0) {
      ...
      frappe.call({
        method:
          "go1_cms.go1_cms.doctype.proposal.proposal.update_section_content",
        args: {
          docs: results,
  ...
  show_list_modal: function (index, data, type, edit_data) {
    ...
    $(fields_list).each(function (k, v) {
      ...
      else if (v.field_type == "Text Editor") obj.fieldtype = "Text Editor";
      else if (v.field_type == "Attach Video") obj.fieldtype = "Attach";
      else if (v.field_type == "Check") obj.fieldtype = "Check";
      ...
      if (data && data.length > 0) {
        ...
        data.map((f) => {
          ...
          row.find(".btn-danger").click(function () {
            ...
            frappe.call({
              method:
                "go1_cms.go1_cms.doctype.proposal.proposal.update_featured_item",
              args: {
                doctype: me.fields.reference_document,
                name: val.preitem,
                checked: 1,
  ...
  get_predefined_records: function (name, dt, no_of_records, business) {
    ...
    frappe.call({
      method:
        "go1_cms.go1_cms.doctype.proposal.proposal.get_predefined_records",
      args: {
        dt: dt,
  ...
  get_collections_records: function (collections) {
    ...
    frappe.call({
      method:
        "go1_cms.go1_cms.doctype.proposal.proposal.get_collection_records",
      args: {
  ...
  upload_component: function (target, progress) {
    ...
    var uppy = Uppy.Core({
      ...
      .use(Uppy.XHRUpload, {
        endpoint:
          window.location.origin +
          "/api/method/go1_cms.go1_cms.doctype.proposal.proposal.upload_img",
        method: "post",
        formData: true,
        fieldname: "file",
        headers: {
        ...
        if (
          ...
          frappe.confirm(
            ...
            () => {
              frappe.call({
                method:
                  "go1_cms.go1_cms.doctype.proposal.proposal.import_sections_from_template",
                args: {
...
var add_list_template = Class.extend({
  ...
  get_page_templates: function () {
    ...
    frappe.call({
      method:
        "go1_cms.go1_cms.doctype.proposal.proposal.get_list_page_templates",
      args: {},
      async: false,
      callback: function (r) {
