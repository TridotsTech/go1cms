...
frappe.ui.form.on('Web Page Builder', {
    ...
    refresh: function(frm) {
        ...
        if(frm.doc.document && frm.doc.w_page_type=="List"){
           frm.set_query("data_fetch_from", function() {
            return {
                "query":"go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_linked_docs",
                "filters": {
        ...
        if(frm.doc.document && frm.doc.w_page_type=="Detail"){
              frappe.call({
                        method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_linked_fields',
                        args: {
                             "document": frm.doc.document
                        },
                        freeze: true,
               ...
               var title_dialog =   new frappe.ui.Dialog({
                     ...
                     title_dialog.set_primary_action(__('Save As Template'), function() {
                         let val = title_dialog.get_values();
                          frappe.call({
                                method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.save_as_template',
                                args: {
    ...
    store_global_font_and_weight_values(frm){
        ...
        .then(r => {
            if(r && r.message && r.message.name){
                frappe.call({
                    method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_global_fonts',
                    args: {
    ...
    delete_sections: function(frm, name, parentfield) {
        frappe.confirm(
            ...
            function(){
              frappe.call({
                    method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.delete_section',
                    args: {
                        name: name,
    ...
    edit_styles_sections: function(frm, name, parentfield) {
        var id=name;
        frappe.call({
                method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_section_properties',
                        ...
                        //    console.log(">> Submitted value <<",values)
                           ...
                           for (let k in values) {
                            ...
                            $('[data-fieldname="'+id+'"]').attr("style_json",JSON.stringify(style_json))
                             frappe.call({
                                method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.update_section_properties',
...
var add_new_section = Class.extend({
    ...
    get_all_sections: function() {
        let me = this;
        frappe.call({
            method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_sections',
            args: {
                              ...
                              frappe.call({
                                  ...
                                  callback: function(r) {
                                      if (r.message) {
                                          ...
                                          row.custom_title = r.message.custom_title;
                                          row.allow_update_to_style = r.message.allow_update_to_style;
                                          me.frm.refresh_field(me.parentfield);
                                          me.frm.save();
                                          me.dialog.hide();
                                          title_dialog.hide();  
                                      }
...
var modify_section_data = Class.extend({
    ...
    get_data_fields: function() {
        let me = this;
         // console.log(me,"me----")
        frappe.call({
            method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_section_content',
            args: {
                section: me.section,
    ...
    make_dialog: function() {
        ...
        frappe.call({
            ...
            args: {
                ...
                'fieldname': ['section_name', 'section_title', 'layout_id']
            },
            async: false,
            callback: function(r) {
                // console.log("----------sec--------")
                ...
                if (r.message) {
                    ...
                    if (r.message.layout_id) {
                        me.layout_id = r.message.layout_id;
                    } else {
                        me.layout_id = null;
                    }
                }
       ...
       //  }
        ...
        if (this.fields && this.fields.section_type == 'Custom Section') {
            ...
            if(this.fields.reference_document !="Blog Category"){
                if (this.dialog.fields_dict.reference_name && this.dialog.fields_dict.fetch_product) {
                ...
                if (this.dialog.fields_dict.reference_name) {
                    me.dialog.fields_dict.reference_name.$wrapper.removeClass('hide-control');
                }
            }
...
var add_page_template = Class.extend({
    ...
    get_page_templates: function() {
        let me = this;
        frappe.call({
            method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_page_templates',
            args: {
            ...
            item.click(function() {
                if(cur_frm.doc.page_title!="" && cur_frm.doc.page_title!=undefined){
                    ...
                    frappe.confirm('Are you sure you want to proceed?',
                        () => {
                             frappe.call({
                                    method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.import_sections_from_template',
                                    args: {
...
var add_list_template = Class.extend({
    ...
    get_page_templates: function() {
        let me = this;
        frappe.call({
            method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_list_page_templates',
            args: {
            },
            async: false,
            callback: function(r) {
...
var columns_mapping = Class.extend({
    ...
    get_section_columns: function() {
        let me = this;
        frappe.call({
            method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_section_columns',
            args: {
...
var add_detail_template = Class.extend({
    ...
    get_page_templates: function() {
        let me = this;
        frappe.call({
            method: 'go1_cms.go1_cms.doctype.web_page_builder.web_page_builder.get_detail_page_templates',
            args: {
            },
            async: false,
            callback: function(r) {
